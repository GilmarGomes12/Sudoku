...
public class SudokuController implements Initializable {
    ...
    private void setValue(){
        ...
        for(int a=0; a<9; a++){
            for(int b=0; b<9; b++){
                ...
                if(LevelController.level.equals("Fácil")) {
                ...
                }else if(LevelController.level.equals("Médio")) {
                    if(random1.nextInt(3)<=1) {
                        i[a][b] = 0; counter++;
                        if(counter>54){
                            port1 = true;
                ...
                }else if(LevelController.level.equals("Difícil")) {
                ...
                }else if(LevelController.level.equals("Especialista")) {
                ...
                }else if(LevelController.level.equals("Malvado")) {
    ...
    public void btn_result(ActionEvent actionEvent) throws IOException {
        ...
        if(joy==81){
            messageResult = "Parabéns!!!! Você ganhou.";
            message(actionEvent);

        }else{
            messageResult = "Você perdeu. Tente novamente...";
            message(actionEvent);
        }
    }
}
